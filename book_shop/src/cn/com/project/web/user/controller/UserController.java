...
public class UserController {
	 ...
	 * @返回值:ModelAndView
	 */
	@RequestMapping(value="/deleteMyBook")
	public String deleteMyBook(Integer id,HttpServletRequest request)throws Exception{
		userService.deleteMyBook(id);
		 return "redirect:/web/oper/selMyBook";
	}
}