...
public class UploadController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			String method = request.getParameter("method");
				...
				}else if("saveMyBook".equals(method)){
					 FileUploadTool fut = new FileUploadTool(request);
						fut.upload();
						String id = (String)request.getSession().getAttribute("number");
						String sname = fut.getParameter("sname");
						String price = fut.getParameter("price");
						String writer = fut.getParameter("writer");
						String number = fut.getParameter("number");
						String press = fut.getParameter("press");
						String miaoshu = fut.getParameter("miaoshu");
						String photo = fut.getParameter("photo");
						UsedBook sp = new UsedBook();
						sp.setSname(sname);
						sp.setPress(press);
						sp.setPrice(price);
						sp.setPhoto(photo);
						...
						sp.setWriter(writer);
						sp.setuId(id);
						new UploadService().addBook(sp);
					response.sendRedirect("web/oper/selMyBook");
				}
			}
}
