...
public class UploadService {
	 ...
	 * @返回值：void
	 */
	public void addBook(UsedBook sp){
		String sql = "insert into usedbook (u_id,sname,price,writer,photo,miaoshu,number,press)values(?,?,?,?,?,?,?,?)";
		new DB().update(sql,new String[]{sp.getuId(),sp.getSname(),sp.getPrice(),sp.getWriter(),sp.getPhoto(),sp.getMiaoshu(),sp.getNumber(),sp.getPress()});
	}
}
