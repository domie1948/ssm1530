...
<div id="sp">
	<div class="content">
		<div class="right">
			<div class="js1 pl8">购买了此商品的用户还浏览了</div>
			<ul>
				<li>
					<dl>
						<dt><img src="<%=basePath%>index/temp/img/class_1.jpg" alt="" /></dt>
						<dd><a href="sp.html">【蔡康永推荐】</a></dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt><img src="<%=basePath%>index/temp/img/class_2.jpg" alt="" /></dt>
						<dd><a href="sp.html">双语阅读</a></dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt><img src="<%=basePath%>index/temp/img/class_3.jpg" alt="" /></dt>
						<dd><a href="sp.html">迪士尼推荐</a></dd>
					</dl>
				</li>
				<li>
					<dl>
						<dt><img src="<%=basePath%>index/temp/img/class_4.jpg" alt="" /></dt>
						<dd><a href="sp.html">特种兵学校</a></dd>
					</dl>
				</li>
			</ul>
		</div>
